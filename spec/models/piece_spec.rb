...
RSpec.describe Piece, type: :model do
  describe "Piece#move_to" do
    it "moves a piece to an empty square" do
      piece = FactoryBot.create(:piece,x_position:2,y_position:2)
      #puts piece.game_id
    ...
    it "captures a piece that was at the space it's moving to" do
      piece_1 = FactoryBot.create(:piece,x_position:2,y_position:2)
      piece_2 = FactoryBot.create(:piece, piece_color: "black", game: piece_1.game, x_position: 3, y_position: 3)
    ...
    it "does not capture a piece that was at the space it's moving to if that piece belongs to another game" do
      piece_1 = FactoryBot.create(:piece,x_position:2,y_position:2)
      piece_2 = FactoryBot.create(:piece, piece_color: piece_1.piece_color,game:piece_1.game, x_position: 3, y_position: 3)
      piece_1.move_to(3, 3)
      piece_1.reload
      piece_2.reload
