...
RSpec.describe King, type: :model do
    describe "King#update" do
        it "successfully updates record when King is moved to correct location" do
            ...
            piece = Piece.create(piece_type:"King",piece_color:"white",type:"King",x_position:1,y_position:1)
            move = Piece.find(piece.id).update_attributes(x_position:2,y_position:2)
